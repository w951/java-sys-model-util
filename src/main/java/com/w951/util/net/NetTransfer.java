...
public class NetTransfer {
	...
	public static int reverseInt(int i) {
		int result = NetTransfer.hBytesToInt(NetTransfer.toLH(i));
		return result;
	}
	...
	public static short reverseShort(short s) {
		short result = NetTransfer.hBytesToShort(NetTransfer.toLH(s));
		return result;
	}
	...
	public static float reverseFloat(float f) {
		float result = NetTransfer.hBytesToFloat(NetTransfer.toLH(f));
		return result;
	}
}
